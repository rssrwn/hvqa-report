...
The following is the specification for the OceanQA dataset environment:
\begin{equation}
  \begin{split}
    \textit{num\_frames} & ::= 32 \\

    \textit{classes} & ::= \{ \langle \text{octopus}, \textit{false} \rangle, \text{fish}, \textit{true} \rangle, \text{bag}, \textit{true} \rangle, \text{rock}, \textit{true} \rangle \} \\
