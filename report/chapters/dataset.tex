...
% In this sense, VideoQA tasks can resemble `semi-supervised' tasks, where a model is given partially labelled data, but asked to label most, if not all, of the data.
