...
\begin{enumerate}
  ...
  \item Action questions ask which action occurred between two frames of a video. `Move' actions account for around $45\%$ of answers to these questions, while `rotate left' and `rotate right' account for approximately $27.5\%$ of questions each. The answer to these questions will never be `nothing'. The grammar for action questions ans answers is as follows:
  \begin{equation}
    \begin{split}
