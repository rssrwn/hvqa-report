...
% Equation~\ref{eqn:event-rule-layout} shows that 

% The algorithm therefore needs to search over a set of features and, for each feature, a set of defined feature operations in order to find the set of operation results which can explain the actions
