...
\begin{table}[b]
  ...
  \begin{tabular}{ |c|c c| }
    ...
    \hline
  \end{tabular}
  \caption{Details of the layers of each relation classification network. The input is the size of two encoded objects, and the output is used for binary classification.}
