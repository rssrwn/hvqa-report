...
Each feature operation is also assigned a \textit{weight}. The weight of a rule is then the sum of the weights of its operations. Secondary goals for the optimisation algorithm are, firstly, to minimise the number of rules and, secondly, to minimise the sum of weights of the rules.
