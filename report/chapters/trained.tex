...
\begin{itemize}
  ...
  \begin{gather}
    answer(\textit{$<$i$>$}, p_i, V) \text{ :- } \begin{multlined}[t]
      ...
      holds(p_i(V, \mathit{Id}), \textit{$<$i$>$}), obj(\mathit{Id}, \textit{$<$i$>$}).
    \end{multlined} \\
    answer(\textit{$<$i$>$}, p_{v_i}, V) \text{ :- } \begin{multlined}[t]
      holds(p_{v_i}(V, \mathit{Id}), \textit{$<$i$>$}), \\
      holds(p_i(v_i, \mathit{Id}), \textit{$<$i$>$}), obj(\mathit{Id}, \textit{$<$i$>$}).
    \end{multlined} \\
    expected(\textit{$<$i$>$}, p_i, a_i). \\
    expected(\textit{$<$i$>$}, p_{v_i}, v_i).
  \end{gather}

  For example, the question ``What colour is the downward-facing bag in frame 7?" and answer ``white", would be converted into the following ASP rules and facts:
  \begin{gather}
    answer(\textit{$<$i$>$}, colour, V) \text{ :- } \begin{multlined}[t]
      holds(rotation(down, \mathit{Id}), \textit{$<$i$>$}), \\
      holds(colour(V, \mathit{Id}), \textit{$<$i$>$}), obj(\mathit{Id}, \textit{$<$i$>$}).
    \end{multlined} \\
    answer(\textit{$<$i$>$}, rotation, V) \text{ :- } \begin{multlined}[t]
      holds(rotation(V, \mathit{Id}), \textit{$<$i$>$}), \\
      holds(colour(white, \mathit{Id}), \textit{$<$i$>$}), obj(\mathit{Id}, \textit{$<$i$>$}).
    \end{multlined} \\
  ...
  \begin{gather}
    answer(\textit{$<$i$>$}, p_i, V) \text{ :- } holds(p_i(V, \mathit{Id}), \textit{$<$i$>$}), obj(\mathit{Id}, \textit{$<$i$>$}). \\
    expected(\textit{$<$i$>$}, p_i, a_i).
  \end{gather}
\end{itemize}
