...
\begin{figure}[t]
  ...
  \caption{Architecture of the properties component neural network. An object is encoded into a latent vector, before a set of fully-connected layers produce a set of probability distributions over the property values. FM stands for feature maps.}
  \label{fig:prop-network}
\end{figure}

The full-data version of the OceanQA dataset labels both the colour and rotation of every object in every frame. This makes training a neural network relatively straightforward; we simply collate all of the objects in the dataset, resize each object to 32x32 pixels and train the network using batches of 256 objects with a learning rate of 0.001 for 2 epochs.
