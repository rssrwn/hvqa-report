...
\begin{enumerate}
  ...
  \item For each frame, we keep track of the both identifiers and the set of objects which are competing for each identifier.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\textwidth]{detection-error.png}
