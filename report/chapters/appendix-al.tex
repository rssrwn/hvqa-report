...
\chapter{ASP encoding of $\mathcal{AL}$}
\label{appendix-al}
...
Finally, in order to make use of the system description encoding we would include information on which events occured, using the $occurs(A, I)$ predicate, and information on the different states of the system using $holds(F, I)$ and $\neg holds(F, I)$.
