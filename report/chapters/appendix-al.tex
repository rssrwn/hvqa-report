...
\begin{itemize}
  ...
  \begin{equation}
    h(l, I+1) \text{ :- } h(p_0, I),..., h(p_m, I), occurs\_action(a, I), I < n.
  \end{equation}
  ...
  \begin{equation}
    \neg occurs\_action(a_0, I) ; ... ; \neg occurs\_action(a_k, I) \text{ :- } h(p_0, I),..., h(p_m, I).
...
\begin{itemize}
  ...
  \begin{equation}
    \neg occurs\_action(A, I) \text{ :- } action(A), step(I), not \text{ } occurs\_action(A, I).
  \end{equation}
\end{itemize}
