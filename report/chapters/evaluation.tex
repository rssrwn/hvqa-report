...
\begin{table}[h]
  ...
  \begin{tabular}{ |c|c| }
    ...
    \hline
  \end{tabular}
  \caption{Mean average precisions for a number of IoU thresholds. A threshold of 0.5~:~0.95 indicates an average mAP value for the set of thresholds $\{ 0.5, 0.55, ..., 0.95 \}$.}
