...
\begin{enumerate}
  ...
  % As Table~\ref{table:model-question-acc} shows, the performance difference is most pronounced for the questions which relate to events.
...
% Table~\ref{table:model-question-acc} provides a breakdown of the models' accuracy on each question type.
